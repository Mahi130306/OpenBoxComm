  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
      ...
      <div className="mb-16 text-center">
        <Badge variant="outline" className="mb-4 border-indigo-500/30 text-indigo-400 px-4 py-1">
          Support Hub
        </Badge>
        <h1 className="mb-6 text-5xl font-black tracking-tighter sm:text-6xl lg:text-7xl">
          Get in <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-600">Touch.</span>
        </h1>
        <p className="mx-auto max-w-2xl text-xl text-muted-foreground">
          We're a community-driven network. Whether you have a technical issue or want to partner, we're listening.
        </p>
      </div>
